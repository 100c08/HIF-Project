  ...
  return (
    <div className={`${playfairDisplay.variable} ${iropke.variable}`}>
      ...
      <div className={styles.heroSection}>
        ...
        <h1 className={styles.heroTitle}>Recruiting</h1>
        ...
        <div className={styles.contentSection}>
          ...
          <div className={styles.circleContainer}>
            ...
            <div className={`${styles.circleItem} ${styles.fadeInSecond}`}>
              <div className={styles.circleWrapper}>
                ...
                <h3
                  className={`${styles.pointTitle} ${styles.interactionColor}`}
                >
                  Initiative
                </h3>
                <p className={styles.circleText}>
            ...
            <div className={`${styles.circleItem} ${styles.fadeInThird}`}>
              <div className={styles.circleWrapper}>
                ...
                <h3 className={`${styles.pointTitle} ${styles.financeColor}`}>
                  Finance
                </h3>
                <p className={styles.circleText}>
                  금융에 대한 관심이 높으신 분
          ...
          <div className={styles.applicationInfo}>
            <div className={styles.infoRow}>
              ...
              <p className={styles.infoContent}>
                한국외국어대학교 <strong>서울캠퍼스</strong>에서 재학 중이며,{" "}
                <strong>2개 학기 연속 참여</strong>가 가능하신 분
              </p>
            </div>
            <div className={styles.infoRow}>
              <span className={styles.infoLabel}>지원방법</span>
              <p className={styles.infoContent}>
                페이지 하단에서 지원서를 다운로드하여 작성 후{" "}
                <a
                  href="mailto:hufsvalue15@naver.com"
                  className={styles.emailLink}
                >
                  hufsvalue15@naver.com
                </a>
                으로 제출
              </p>
            </div>
          ...
          <div className={styles.timelineSection}>
            ...
            <p className={styles.finalMessage}>
              대한민국 최고의 금융학회, 금융연구회에서
              <br />
              잠재력을 발휘하고 미래 금융인으로 성장하실 분을 찾습니다.
            </p>

            <a
              href="/000_17.5기 지원서.docx"
              download="000_17.5기 지원서.docx"
