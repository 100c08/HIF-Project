  ...
  return (
    <div className={playfairDisplay.variable}>
      ...
      <div className={styles.heroSection}>
        ...
        <h1 className={styles.heroTitle}>Regular Session</h1>
      ...
      <div className={styles.mainContent}>
        <div className={styles.contentSection}>
          ...
          <p className={styles.description}>
            금융연구회는{" "}
            <strong>학회원 전원이 참여하는 세미나 활동을 진행</strong>하고
            있습니다.
            {!isMobile && <br />}
            세미나는 4명 내외의 학회원이 팀을 이루어 주제 선정부터 자료 준비,
            발표까지 함께 협력하며
            {!isMobile && <br />}
            금융과 경제 분야에 있어{" "}
            <strong>학술 역량을 배양하는 핵심 활동</strong>입니다.
          </p>

          <div
            className={`${styles.seminarGrid} ${isVisible ? styles.visible : ""}`}
          >
            <div className={`${styles.seminarItem}`}>
              ...
              <a
                href="/[2024.10.03 세미나 A조] 크레딧 일부 발췌.pdf"
                download
            ...
            <div className={`${styles.seminarItem}`}>
              ...
              <a
                href="/[2024.04.04 세미나 A조] SPAC투자 일부 발췌.pdf"
                download
                className={styles.downloadLink}
              >
                세미나 자료 보기
            ...
            <div className={`${styles.seminarItem}`}>
              ...
              <a
                href="/[2025.05.15 세미나 A조] 자산배분전략 일부발췌.pdf"
                download
                className={styles.downloadLink}
              >
                세미나 자료 보기
          ...
          <p className={styles.seminarFooter}>
            세미나는 학회원의 학문적 깊이를 더하고, 분석 능력과 발표 능력을
            함양하며,
            {!isMobile && <br />}
          ...
          <p className={styles.description}>
            매주 <strong>기업분석, 정책금융, 매크로이슈</strong> 등을 주제로
            학회원 간의 심도 깊은 학습을 진행하며,{" "}
            <strong>금융시장 이슈들을 Follow-up</strong>하고 있습니다. 이를 통해
            매크로 시황, 포트폴리오 전략 등 다양한 금융분야의 인사이트를 습득할
            수 있습니다.
          </p>
          ...
          <div className={styles.newsGrid} ref={marketInsightRef}>
            <div className={`${styles.newsItem} ${styles.topPosition}`}>
              ...
              />
              <a
                href="/[2024.03.26 15기 이영기] The $27 Trillion Treasury Market Is Only Getting Bigger.pdf"
                download
                className={styles.downloadLink}
              >
                전체 보고서 보기
            ...
            <div className={`${styles.newsItem} ${styles.bottomPosition}`}>
              ...
              />
              <a
                href="/[2022.04.06 박영찬] 미 장단기 금리역전. 이번에도 심각한 경기침체 신호일까.pdf"
                download
                className={styles.downloadLink}
              >
                전체 보고서 보기
            ...
            <div className={styles.newsItem}>
              ...
              />
              <a
                href="/[2026.3.10] 16기_현채연_p-cbo_부실_증가.pdf"
                download
                className={styles.downloadLink}
              >
                전체 보고서 보기
            ...
            <div className={styles.newsItem}>
              ...
              />
              <a
                href="/[26.03.16] 14.5기 방창현, 사모신용시장 구조와 리스크.pdf"
                download
                className={styles.downloadLink}
              >
                전체 보고서 보기
            ...
            <div className={`${styles.newsItem} ${styles.topPosition}`}>
              ...
              />
              <a
                href="/[2024.09.28. 15기 이영기] 미국서 외면받는 배당성장 ETF…한국 개미만 쓸어담아.pdf"
                download
                className={styles.downloadLink}
              >
                전체 보고서 보기
