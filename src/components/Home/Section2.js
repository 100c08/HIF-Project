        ...
        <div className={styles.textSection}>
          ...
          <div className={styles.textContent}>
            ...
            <p className={`${styles.introText} ${styles.fadeUpAnimation4}`}>
              금융연구회는 2010년 설립된 한국외국어대학교<br />
              경영대학 소속의 금융 전문 학회입니다
            </p>
            <p className={`${styles.detailText} ${styles.fadeUpAnimation5}`}>
              우리 학회는 금융세미나, 신문스터디, 공모전 참가 등 다양한 활동을 통해<br />
              경제와 금융에 대한 폭넓은 지식을 쌓고, 선후배 간의 긴밀한 네트워크를<br />
              바탕으로 금융시장 동향 및 실무 인사이트를 학습합니다.<br />
              이를 통해 구성원들은 전문성을 갖춘<br />
              금융 인재로 성장해 나갑니다.
            </p>
          </div>
        </div>
